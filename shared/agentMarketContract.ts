 ...
 * `services` routers; Indexer-backed `stellar.*` reads; agent payment/receipt UI state.
 *
 ...
 * and Algorand token custody / SAC transfers (escrow release still coordinates offchain).
 *
