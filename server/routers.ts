  ...
  search: router({
    ...
    getResult: publicProcedure
      ...
      .query(async () => ({
        status: "completed",
        results: [
          { title: "Algorand Protocol Documentation", url: "https://developer.algorand.org", snippet: "Official Algorand protocol documentation..." },
    ...
    getDetails: publicProcedure
      ...
      .query(async ({ input }) => {
        const services: Record<string, any> = {
          "web-search": { id: "web-search", name: "Web Search", description: "Search the web with AI-powered agents", price: 0.001, rateLimit: 1000, period: "day", documentation: "https://docs.algorand.co/web-search", status: "available" },
          "market-data": { id: "market-data", name: "Market Data", description: "Real-time cryptocurrency and stock market data", price: 0.002, rateLimit: 500, period: "day", documentation: "https://docs.algorand.co/market-data", status: "available" },
          "news-feed": { id: "news-feed", name: "News Feed", description: "Curated news and updates from multiple sources", price: 0.001, rateLimit: 2000, period: "day", documentation: "https://docs.algorand.co/news-feed", status: "available" },
        };
