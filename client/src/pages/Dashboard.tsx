...
export default function Dashboard() {
  ...
  const [walletAddress] = useState("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAY57VWW6A");
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground">Monitor your AlgorandHacks Agent activity and transactions</p>
        </div>
