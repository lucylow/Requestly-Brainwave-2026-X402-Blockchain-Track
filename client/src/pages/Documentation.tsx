  ...
  const docs = [
    {
      ...
      description: "Learn how to set up AlgorandHacks Agents in your project",
      icon: BookOpen,
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      title: "x402 Protocol",
      description: "Understanding micropayments on Algorand",
      icon: Zap,
    },
  ];
  ...
  const codeExamples = [
    {
      ...
      language: "javascript",
      code: `import { AlgorandHacksClient } from '@algorandhacks/client';

const client = new AlgorandHacksClient({
  apiKey: 'your-api-key',
  network: 'testnet'
});`,
    },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground">Everything you need to integrate AlgorandHacks Agents</p>
        </div>
        ...
        <Card className="p-8 bg-card border-border mb-12">
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: "Install Package", cmd: "npm install @algorandhacks/client" },
              { step: 2, title: "Import Client", cmd: "import { AlgorandHacksClient } from '@algorandhacks/client';" },
              { step: 3, title: "Initialize", cmd: "const client = new AlgorandHacksClient({ apiKey: 'your-key' });" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <Card className="p-6 bg-card border-border">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-accent hover:underline">→ Algorand Documentation</a>
              </li>
              <li>
        ...
        <Card className="p-8 bg-card border-border">
          ...
          <div className="space-y-4">
            {[
              { q: "What is x402?", a: "x402 is a micropayment protocol that enables pay-per-query functionality on Algorand." },
              { q: "How do I get an API key?", a: "Sign up on our platform and generate an API key from your dashboard." },
              { q: "What networks are supported?", a: "We support both Algorand testnet and mainnet." },
              { q: "Can I use this in production?", a: "Yes, AlgorandHacks is production-ready and audited." },
            ].map((item, idx) => (
