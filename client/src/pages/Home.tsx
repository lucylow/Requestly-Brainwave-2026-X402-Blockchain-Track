 ...
 * - Wallet: detection vs connected vs Indexer account was easy to confuse; status strip + readiness labels fix that.
...
import { useAlgorandWallet as useAlgorandWallet } from "@/_core/context/AlgorandWalletContext";
...
function HomeShell() {
  ...
  const landingPreview = useMemo(
    () => ({
      ...
      query: "USDC liquidity routes on Algorand",
    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 min-w-0">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-lg font-semibold tracking-tight text-[var(--text)] truncate">Algorand agent console</h1>
                  <p className="text-xs text-[var(--muted-text)]">Wallet · x402 demo · Search MCP · Indexer</p>
                </div>
              </div>
              <nav
      ...
      >
        <div className="container mx-auto px-4 py-2.5 text-xs text-[var(--muted-text)] flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-4 sm:gap-y-1">
          ...
          <span>
            ...
            {freighterAvailable === true && "Detected"}
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="text-sm text-[var(--muted-text)] max-w-2xl leading-relaxed mt-1">
                One surface for wallet health, explicit x402 approval, Search MCP catalog inspection, Algorand market context,
        ...
        {!isConnected && (
          <Alert className="border-cyan-500/25 bg-[var(--surface)]/80">
            ...
            <AlertDescription className="text-[var(--muted-text)] text-sm leading-relaxed">
              Chat, tasks, and mock search run without a wallet. Connect when you want live balances and
              Algorand activity in the dashboard.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
          <div className="xl:col-span-3 space-y-6 min-w-0">
            ...
            <AppSection
              ...
              description="Live Indexer rows for the connected address when a wallet is ready."
            >
          ...
          <div className="xl:col-span-6 flex flex-col gap-6 min-w-0 min-h-0">
            <AppSection
              ...
              description="Quote → approval → simulated settlement → MCP-backed search. Mirrors the story judges expect from x402 + Algorand."
            >
      ...
      <footer className="border-t border-[var(--border)] bg-[var(--surface)]/85 mt-12">
        <div className="container mx-auto px-4 py-6 text-center text-xs text-[var(--muted-text)]">
          Algorand agent console · Indexer {networkLabel} ·{" "}
          <a
          ...
          ·{" "}
          <a href="https://perawallet.app" className="text-[var(--accent-primary)] hover:underline" target="_blank" rel="noreferrer">
            Pera Wallet
          </a>
        </div>
      </footer>
