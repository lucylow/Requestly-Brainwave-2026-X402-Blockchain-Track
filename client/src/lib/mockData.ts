// Mock data for AlgorandHacks Agents product

export const mockWalletState = {
  connected: true,
  address: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAY57VWW6A",
  balance: 50.0,
  currency: "USDC",
...
export const mockPaymentChallenge = {
  id: "challenge_123abc",
  query: "What are the latest developments in Algorand?",
  service: "web-search",
  estimatedCost: 0.001,
  currency: "USDC",
  dailyLimit: 0.05,
...
export const mockContractState = {
  contractId: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAY57VWW6A",
  network: "algorand:testnet",
  owner: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAY57VWW6A",
  dailyLimit: 0.05,
  perQueryLimit: 0.002,
...
export const mockTransactionFeed = [
  {
    ...
    type: "query_approved",
    query: "Algorand blockchain latest news",
    amount: 0.001,
    currency: "USDC",
    status: "confirmed",
...
export const mockFAQ = [
  {
    ...
    answer:
      "x402 is a pay-per-request HTTP protocol that enables micropayments for API calls. On Algorand, it uses USDC ASA for instant settlement.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We support Algorand testnet and mainnet. You can switch networks in the wallet connection panel.",
  },
  {
    question: "How are payments settled?",
    answer:
      "Payments are settled directly on Algorand blockchain via x402. Each transaction is recorded on-chain and visible in the transaction feed.",
  },
  {
...
export const mockInstallationSteps = [
  ...
  },
  {
    ...
    description: "Set up your Algorand wallet and fund it with testnet USDC",
    code: `export ALGORAND_WALLET_MNEMONIC="your mnemonic..."
...
export const mockResources = [
  {
    ...
    description: "Official Algorand developer docs",
  },
  {
    title: "x402 Protocol",
  ...
  },
  {
    ...
    url: "https://github.com/algorand/x402-algorand",
    description: "Official x402 Algorand implementation",
  },
];
