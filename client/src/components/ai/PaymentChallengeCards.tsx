  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-slate-300 leading-relaxed">
        Server-issued quote (x402 / MPP-style negotiation). On Algorand, x402 uses Soroban authorization entries; Pera Wallet
      ...
      <div className="flex flex-wrap items-center gap-2 text-[11px] text-slate-400">
        ...
        {walletConnected ? (
          ...
          <span className="text-amber-200/90">Connect Pera Wallet so the payer address matches your session.</span>
        )}
      </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] text-slate-500">
        Recorded {amount} {currency} — align with Indexer when using live x402 / channel settlement.
      </p>
    </div>
  );
}
