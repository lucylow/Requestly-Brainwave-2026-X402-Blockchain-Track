...
import type { AlgorandNetworkMode } from "@shared/stellarIndexer";
    ...
    return (
      <div className="space-y-3">
        ...
        <Card className="border-amber-500/20 bg-[var(--surface)]/80">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-amber-100">Onchain market (Algorand)</CardTitle>
            <CardDescription className="text-xs text-[var(--muted-text)]">
              Set <span className="font-mono">ALGORAND_AGENT_MARKET_APP_ID</span> on the server. Deploy with{" "}
              <span className="font-mono">pnpm contracts:deploy:testnet</span> after the Algorand SDK is configured.
            </CardDescription>
          </CardHeader>
        </Card>
        {diag.data ? (
    ...
    <div className="space-y-3">
      ...
      <Card className="border-cyan-500/15 bg-[var(--surface)]/80">
        <CardHeader className="pb-2">
          ...
          <CardDescription className="text-xs text-[var(--muted-text)]">
            Live Algorand reads via <span className="font-mono text-[10px] break-all">{cfg.data.rpcUrl}</span>
          </CardDescription>
        </CardHeader>
