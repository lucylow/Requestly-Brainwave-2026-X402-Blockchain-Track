      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block mb-6 px-4 py-2 bg-pink-500/10 border border-pink-500/40 rounded-full">
            <span className="text-sm font-medium text-cyan-300">Pay-Per-Query Web Search MCP on Algorand</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="neon-text animate-neon-pulse">Algorand Hacks</span>
            <br />
            <span className="text-white">AI Agents. Blockchain. x402 Protocol.</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Deploy autonomous AI agents that search the web, pay per query via x402 on Algorand, and settle transactions instantly with full transparency.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            <div className="glass-panel p-6 text-left border-cyan-500/30 hover:border-cyan-500/60 transition-all">
              ...
              <p className="text-sm text-muted-foreground">Algorand blockchain confirms payments in seconds</p>
            </div>
            ...
            <div className="glass-panel p-6 text-left border-cyan-400/30 hover:border-cyan-400/60 transition-all">
              ...
              <p className="text-sm text-muted-foreground">Complete audit trail on Algorand ledger</p>
            </div>
          </div>
        </div>
      </div>
