    ...
    <section id="value" className="py-20 bg-gradient-to-b from-background to-card/20">
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Why AlgorandHacks Agents?</h2>
          <p className="text-lg text-muted-foreground">
            The first production-ready system for monetized agentic search on Algorand. Pay per query, settle instantly, audit everything.
          </p>
        </div>
...
export function SearchDemoSection() {
  const [query, setQuery] = useState("What are the latest developments in Algorand?");
        ...
        {!connected ? (
          <div className="glass-panel p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Connect a Algorand wallet to start making payments and executing queries
            </p>
            <Button
        ...
        <div className="space-y-8">
          <div className="glass-panel p-8">
            ...
            <ol className="space-y-4 list-decimal list-inside">
              <li className="text-muted-foreground">
                Connect your Algorand wallet with USDC balance
              </li>
              <li className="text-muted-foreground">
          ...
          <div className="glass-panel p-8">
            ...
            <ol className="space-y-4 list-decimal list-inside">
              ...
              <li className="text-muted-foreground">
                Configure your Algorand wallet and network
              </li>
              <li className="text-muted-foreground">
    ...
    <footer className="py-12 bg-card/50 border-t border-border/40">
      <div className="container">
        ...
        <div className="border-t border-border/40 pt-8 text-center text-sm text-muted-foreground">
          <p>© 2026 AlgorandHacks Agents. Built on Algorand with x402 payments.</p>
        </div>
      </div>
    </footer>
  );
